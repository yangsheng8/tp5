<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\Program\www\tp5\public/../application/admin\view\links\edit.htm";i:1550026341;s:56:"D:\Program\www\tp5\application\admin\view\common\top.htm";i:1549953780;s:57:"D:\Program\www\tp5\application\admin\view\common\left.htm";i:1550024919;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>友情链接编辑</title>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">编辑友情链接信息</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="title" placeholder="" name="title"  type="text" value="<?php echo $linkss['title']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="url" placeholder="" name="url"  type="text" value="<?php echo $linkss['url']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="desc" class="form-control"><?php echo $linkss['desc']; ?></textarea>
                            </div>
                        </div> 
                        <div class="form-group">
