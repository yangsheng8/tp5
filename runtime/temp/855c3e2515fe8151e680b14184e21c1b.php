<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\Program\www\tp5\public/../application/admin\view\links\lst.htm";i:1550026989;s:56:"D:\Program\www\tp5\application\admin\view\common\top.htm";i:1549953780;s:57:"D:\Program\www\tp5\application\admin\view\common\left.htm";i:1550029580;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    ...
                    <button type="button" tooltip="添加友情链接" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('links/add'); ?>'">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th class="text-center">友情链接标题</th>
                                                    <th class="text-center">友情链接地址</th>
                                                    <th class="text-center">友情链接描述</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('links/del',array('id'=>$vo['id'])); ?>')"
